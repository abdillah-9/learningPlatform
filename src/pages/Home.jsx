...
/>
      ...
      {/* NEXT/PREV BUTTONS */}
      <div className="PicTop" style={{ position: "absolute", top: "50vh", left: '2%', transform: "translateY(-50%)", zIndex: 10, borderRadius: '50%', padding: '10px 13px', backgroundColor: '#0c2247ff', cursor: 'pointer' }} onClick={prev}>
        <CgChevronDoubleLeft style={{ fontSize: '25px', color: 'white' }} />
      </div>

      <div className="PicTop" style={{ position: "absolute", top: "50vh", right: '2%', transform: "translateY(-50%)", zIndex: 10, borderRadius: '50%', padding: '10px 13px', backgroundColor: '#0c2247ff', cursor: 'pointer' }} onClick={next}>
...
useEffect(() => {
  ...
  return (
    <div className={`slideShowHeight ${animate ? 'slideScale' : ''}`} style={{ width: "100vw", position: "relative", overflow: "hidden",height:'100%'}}>
      ...
      {/* NEXT/PREV BUTTONS */}
      <div style={{ position: "absolute", top: "50%", left: '0%', transform: "translateY(-50%)", zIndex: 10, borderRadius: '50%', padding: '7px 10px', backgroundColor: '#0c2247ff', cursor: 'pointer' }} onClick={prev}>
        <CgChevronDoubleLeft style={{ fontSize: '25px', color: 'white' }} />
      </div>

      <div style={{ position: "absolute", top: "50%", right: '0%', transform: "translateY(-50%)", zIndex: 10, borderRadius: '50%', padding: '7px 10px', backgroundColor: '#0c2247ff', cursor: 'pointer' }} onClick={next}>
        <CgChevronDoubleRight style={{ fontSize: '25px', color: 'white' }} />
      </div>
    </div>
  );
    ...
    <div style={{display:'flex', flexWrap:'wrap', gap:'50px', margin:'50px 0px'}}>
      <div style={{display:'flex', flexDirection:'column', gap:'10px', width:'45%', flexGrow:1, minWidth:'250px', padding:'20px'}}>
        ...
        <div style={{fontSize:'25px ', fontWeight:700, display:'flex', flexDirection:'column', gap:'10px',alignItems:"center"}}>
          ...
          <img src={SospeterNew} alt="Sospeter" width={'30%'} height={'auto'} style={{borderRadius:'50%', aspectRatio:1/1,flex:'1 1 200px', objectFit:'cover'}}/>
        </div>

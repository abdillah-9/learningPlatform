...
<div style={{ display: "flex",flexDirection:'column'}}>
    ...
    <div style={{position:'relative', top:0, left:0, width:'100%', minHeight:'80px',height:'fit-content', backgroundColor:'#0C2B4E',color:'white',zIndex:1, display:'flex', justifyContent:'space-between',padding:'0px 15px', alignItems:'center', flexWrap:'wrap', gap:'12px'}}>
      ...
      <div style={{display:'flex', gap:'15px', fontSize:'18px',fontWeight:500}}>
        ...
        <div style={{marginRight:'10px',padding:'10px 5px',borderRadius:'50px', display:'flex', justifyContent:'center', alignItems:'center', textAlign:'center', fontSize:"14px", fontWeight:600, cursor:'pointer', gap:'4px'}} onClick={()=>{navigateTo('/view_all_courses')}}>
    ...
    <div style={{height:'auto',width:'100vw', position:'relative', overflow:'hidden',aspectRatio:16/9}}>
      ...
      <div style={{position:'absolute', top:0, left:0, width:'100%', height:'100%',backgroundColor:'rgba(1, 1, 54, 0.35)', color:'white', display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column', gap:'30px', textAlign:'center', padding:'10px'}}>
        <h1 style={{fontSize:'40px', fontWeight:800}}>About Us</h1>
        <p style={{fontSize:'20px', fontWeight:500}}>Building a Generation of Founders and C.E.Os</p>
      </div>
    </div>

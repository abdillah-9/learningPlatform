...
<div style={{ display: "flex",flexDirection:'column'}}>
    ...
    <div style={{height:'auto',width:'100vw', position:'relative', overflow:'hidden',aspectRatio:16/9}}>
      ...
      <div style={{position:'absolute', top:0, left:0, width:'100%', height:'100%',backgroundColor:'rgba(1, 1, 54, 0.35)', color:'white', display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column', gap:'50px', textAlign:'center', padding:'10px'}}>
        <h1 style={{fontSize:'40px', fontWeight:800}}>About Us</h1>
        <p style={{fontSize:'20px', fontWeight:600}}>Building a Generation of Founders and C.E.Os</p>
      </div>
    </div>

                        ...
                        <div style={{display:'flex', flexDirection:'column',gap:'10px'}}>
                            ...
                            <section style={{display:'flex', flexDirection:'column', gap:'20px'}}>
                                ...
                                <div key={index}  style={{display:'flex', gap:'10px', alignItems:'', justifyContent:'space-between', fontSize:'15px', flexWrap:'wrap'}} > 
                                    <div style={{paddingLeft:'30px', cursor:'pointer', border:'1px solid blue', maxWidth:'700px', width:'100%'}} onClick={()=>{navigateTo(`main_App/moduleId/${item.id}`)}}>
                                        <div style={{fontSize:'16px', fontWeight:500, display:'flex', width:'100%', justifyContent:'space-between', flexWrap:'wrap', gap:'12px', alignItems:'center',border:'1px solid red'}}>

        ...
        <div style={{width:'100vw', display:'flex', flexDirection:'column', gap:'40px', backgroundColor:'rgba(225, 227, 253, 1)',}}>
            <nav style={{backgroundColor:'#253957', display:'flex', justifyContent:'space-between', padding:'40px 50px 20px 50px', color:'white', flexWrap:'wrap', gap:"15px"}}>
                ...
                <div style={{display:'flex', gap:'20px', height:'fit-content', }}>
                    ...
                    <div style={{borderRadius:'3px', padding:'10px', fontWeight:700, border:'1px solid rgba(70, 169, 194, 1)', color:'rgba(70, 169, 194, 1)', cursor:'pointer', height:'fit-content'}} onClick={()=>{navigateTo('/auth/register')}}>
                        REGISTER
                    </div>
                    <div style={{borderRadius:'3px', padding:'10px', fontWeight:700, color:'white', backgroundColor:'rgba(70, 169, 194, 1)', cursor:'pointer', height:'fit-content'}} onClick={()=>{navigateTo('/auth/sign_in')}}>SIGN IN</div>
                </div>
            </nav>
            ...
            <section style={{width:'93%', backgroundColor:'white', alignSelf:'center', padding:'15px'}}>
                ...
                <div style={{border:'1px solid black', display:'flex', flexWrap:'wrap', padding:'20px', gap:'30px', justifyContent:'space-between', alignItems:'center'}}>
                    <div style={{flex:'1 1 60%',display:'flex', flexDirection:'column'}}>
                        ...
                        <span style={{background:'#eebd3e', padding:'10px', color:'#ffffffff', fontSize:'18px', textAlign:'center', marginTop:'20px', width:'fit-content', borderRadius:'5px', cursor:'pointer', fontWeight:600}}>
